...
class UserData with ChangeNotifier {
  final String url_to_user_list =
      //    "http://192.168.1.120/icesystemomnoi/frontend/web/api/customer/list";
      // "http://103.253.73.108/icesystemomnoi/frontend/web/api/customer/list";
      //  "http://103.253.73.108/icesystemomnoi/frontend/web/api/customer/list";
      "http://103.253.73.108/icesystemomnoi/frontend/web/api/customer/list";
  // "http://103.253.73.108/icesystemomnoi/frontend/web/api/customer/list";
  final String url_to_user_login =
      //  "http://192.168.1.120/icesystemomnoi/frontend/web/api/authen/login";
      // "http://103.253.73.108/icesystemomnoi/frontend/web/api/authen/login";
      // "http://103.253.73.108/icesystemomnoi/frontend/web/api/authen/login";
      "http://103.253.73.108/icesystemomnoi/frontend/web/api/authen/login";
  final String url_to_user_login_qrcode =
      ...
      // "http://103.253.73.108/icesystemomnoi/frontend/web/api/authen/login";
      // "http://103.253.73.108/icesystemomnoi/frontend/web/api/authen/login";
      "http://103.253.73.108/icesystemomnoi/frontend/web/api/authen/loginqrcode";
