...
import 'package:ice_app_new_omnoi/models/paymentdaily.dart';
import 'package:ice_app_new_omnoi/models/paymenthistory.dart';
import 'package:ice_app_new_omnoi/models/paymentselected.dart';

import 'package:shared_preferences/shared_preferences.dart';
import 'package:ice_app_new_omnoi/models/paymentreceive.dart';
...
class PaymentreceiveData with ChangeNotifier {
  final String url_to_payment_list =
      ...
      "http://103.253.73.108/icesystemomnoi/frontend/web/api/paymentreceive/list";
  ...
  final String url_to_add_payment =
      ...
      "http://103.253.73.108/icesystemomnoi/frontend/web/api/paymentreceive/addpay";
  final String url_to_add_payment2 =
      //    "http://192.168.1.120/icesystem/frontend/web/api/paymentreceive/addpay";
      "http://103.253.73.108/icesystemomnoi/frontend/web/api/paymentreceive/addpay2";
  final String url_to_delete_payment_line =
      "http://103.253.73.108/icesystemomnoi/frontend/web/api/paymentreceive/deletepay";
  //  "http://192.168.1.120/icesystem/frontend/web/api/paymentreceive/deletepay";
  //
  //
  //
  final String url_to_payment_daily =
      "http://103.253.73.108/icesystemomnoi/frontend/web/api/paymentreceive/paymentdaily";
  final String url_to_payment_history =
      "http://103.253.73.108/icesystemomnoi/frontend/web/api/paymentreceive/paymenthistory";
  final String url_to_payment_history_cancel =
      "http://103.253.73.108/icesystemomnoi/frontend/web/api/paymentreceive/paymentcancel";
